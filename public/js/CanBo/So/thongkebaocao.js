...
let adsReports = [
  ...
  [7, "nthphuc21@clc.fitus.edu.vn", 1, 22, 3, "Đinh Minh Hiếu", "dmhieu@gmail.com", "0776543210", "Quảng cáo không truyền đạt được ưu điểm đặc biệt của sản phẩm hoặc dịch vụ. Mong muốn doanh nghiệp xem xét việc tăng cường thông tin để người tiêu dùng hiểu rõ về giá trị của sản phẩm.", "2023-09-08", 0, ""],
  ...
  [10, "ncluan21@clc.fitus.edu.vn", 1, 17, 2, "Trần Thị Mai", "ttmai@gmail.com", "0943210765", "Ghi nhận quảng cáo chính trị với thông tin đầy đủ. Mong muốn biết rõ về nội dung, nguồn gốc và mục tiêu của quảng cáo để hiểu rõ hơn về các chủ đề chính trị đang được thảo luận.", "2023-09-26", 0, ""],
  ...
  [12, "nthphuc21@clc.fitus.edu.vn", 1, 17, 4, "Phan Thị Oanh", "ptoanh@gmail.com", "0732123456", "Quảng cáo một dịch vụ giải quyết vấn đề y tế. Đề xuất cung cấp thông tin chi tiết về cách dịch vụ hoạt động và chi phí liên quan. Đây là một vấn đề quan trọng, nên cần thông tin đầy đủ để đưa ra quyết định.", "2023-10-09", 0, ""],
  ...
  [15, "nthphuc21@clc.fitus.edu.vn", 1, 7, 2, "Nguyễn Minh Quân", "nmquan@gmail.com", "0712987654", "Nhìn thấy quảng cáo về chương trình xã hội hóa giúp trẻ em. Đề xuất cung cấp thông tin chi tiết về dự án, cách đóng góp và cách giúp đỡ để người dân có thể tham gia tích cực.", "2023-08-14", 0, ""],
  ...
  [17, "pmlinh21@clc.fitus.edu.vn", 1, 23, 4, "Hồ Thị Thảo", "htthao@gmail.com", "0887654321", "Quảng cáo sản phẩm công nghệ mới. Đề xuất thêm thông tin về tính năng và ưu điểm của sản phẩm để người tiêu dùng có cái nhìn tổng thể trước khi quyết định mua hàng.", "2023-09-10", 0, ""],
  ...
  [19, "nthphuc21@clc.fitus.edu.vn", 1, 5, 1, "Phạm Thị Thu", "ptthu@gmail.com", "0789012345", "Nhìn thấy biển quảng cáo với thông điệp tích cực về chính sách xã hội hóa. Đề xuất tăng cường thông tin về cách đóng góp và mức độ ảnh hưởng của mỗi đóng góp đối với cộng đồng.", "2023-09-23", 0, ""],
  ...
  [21, "nnlien21@clc.fitus.edu.vn", 1, 4, 1, "Trần Thị Xuân", "ttxuan@gmail.com", "0712654321", "Biển quảng cáo thương mại này có vẻ chứa thông tin không chính xác về sản phẩm. Đề nghị kiểm tra và chỉnh sửa thông tin để tránh gây hiểu lầm cho người tiêu dùng.", "2023-09-01", 0, ""],
  [22, "pmlinh21@clc.fitus.edu.vn", 1, 14, 2, "Phan Thanh Yến", "ptyen@gmail.com", "0923456701", "Biển quảng cáo này cần được đăng ký nội dung để đảm bảo tính minh bạch và tuân thủ các quy định về quảng cáo thương mại.", "2023-09-07", 0, ""],
  ...
  [24, "pmlinh21@clc.fitus.edu.vn", 1, 1, 1, "Đinh Văn Đức", "dvduc@gmail.com", "0798765432", "Biển quảng cáo xã hội hóa này chứa thông tin không chính xác về tổ chức hoặc sự kiện. Đề nghị kiểm tra và sửa chữa để tránh gây hiểu lầm cho cộng đồng.", "2023-09-22", 0, "Thực hiện kiểm tra thông tin và yêu cầu chỉnh sửa ngay."],
...
// 	Nguyễn Trần Minh Anh	123@nhomsau	0901234567	1998-02-12	1
// 	Phan Đức Long	123@nhomsau	0907654321	1990-11-04	1
// 	Ngô Minh Tuấn	123@nhomsau	0902828282	1997-09-22	3
// ncluan21@clc.fitus.edu.vn	Nguyễn Hồng Nhung	123@nhomsau	0903737373	2000-01-30	3
...
for (let i = adsCreateRequests.length; i > 0; i--) {
  ...
  td1.className = "id";
  td2.innerHTML = adsCreateRequests[i-1][3];
  td2.className = "id-ads";
  for (let j = 0; j < reportTypes.length; j++) {
      if (adsCreateRequests[j-1][4] == reportTypes[j][0]) {
  ...
  td5.innerHTML = adsCreateRequests[i-1][2];
